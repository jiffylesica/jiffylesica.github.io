...
```{=html}
<div class="card" onclick="location.href='posts/Machine%20Learning%20Blog%20Posts/index.html'" style="cursor: pointer;">
...
::: {.g-col-8}
```{=html}
<div class="card" onclick="location.href='Religion%20Senior%20Research%20Project/index.html'" style="cursor: pointer;">
...
::: {.g-col-8}
```{=html}
<div class="card" onclick="location.href='Women%20Ethnography%20Religion%20Paper/index.html'" style="cursor: pointer;">
  <img src="/img/section-imgs/opening-channels.png" style="width:10%">
